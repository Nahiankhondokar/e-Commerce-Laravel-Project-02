...
<div class="content-wrapper">
  ...
  <div class="card m-auto m-3" style="width: 25rem;">
    ...
    <form class="p-3" action="{{ route('admin.profile.update', $admin -> id) }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
        <input type="file" class="form-control" id="inputTag" name="image">
        @error('image')
      ...
      <img id="imgPriview" class="card-img-top shadow" src="{{ (!empty($admin -> profile_photo_path)) ? url('media/backend/admin' . $admin -> profile_photo_path) : url('media/no_image.jpg') }}" style="width: 100px; height : 100px; border-radius : 50%;border: 1px solid gray;margin: auto;display: block;">
      <br>
